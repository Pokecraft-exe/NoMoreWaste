...
func consulterSignalement(w http.ResponseWriter, r *http.Request, token *IntrospectionPayload) {
	...
	if forumThreadID != nil {
		response["forum_thread_id"] = *forumThreadID
	}
	if forumMessageID != nil {
		response["forum_message_id"] = *forumMessageID
	}
	if annonceMessageID != nil {
		response["annonce_message_id"] = *annonceMessageID
	}
