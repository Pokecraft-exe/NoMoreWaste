...
func main() {
	...
	http.HandleFunc("/api/v1/commercants/rappel", rappelAdhesionCommercantHandler)
	...
	// Sites (siege, agences, entrepots) - read-only listing, used to
	// populate the site_id dropdown when creating a stock.
	http.HandleFunc("/api/v1/sites", sitesHandler)
